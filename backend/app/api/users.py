...
def create_user():
    ...
    if User.query.filter_by(username=data.get('username', None)).first():
        message['username'] = 'Username {} is used, please use a different username.'.format(data.get('username', None))
    if User.query.filter_by(email=data.get('email', None)).first():
        message['email'] = 'Email address {} is used, please use a different username.'.format(data.get('email', None))
    if message:
